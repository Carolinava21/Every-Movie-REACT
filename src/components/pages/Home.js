...
function Home() {
  ...
  const [orderedByPopularity, setOrderedByPopularity] =
    useState("revenue.desc");
  ...
  return (
    <>
      ...
      <HomeMovies
        onChangeGenre={handleChangeSelectedGenre}
        genres={genres}
        onChangeOrder={handleChangeOrdered}
        popularity={popularity}
      />
      <MovieList
        selectedGenre={selectedGenre}
        orderedByPopularity={orderedByPopularity}
        page={page}
        nextPage={nextPage}
